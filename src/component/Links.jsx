...
function Links({name}) {
  ...
  return (
     <section>
          ...
          <a href="https://slack.com/Abdulsalam Bunyamin" className='text-dark fs-3 mt-md-1' target="_blank" rel="noreferrer"><img src={slackImg} alt="" className='img-fluid text-dark fs-3 mt-2 mt-md-3 mx-2 slack-img' /></a>
